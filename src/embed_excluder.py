...
class EmbedExcluder(Client):
    ...
    async def exclude_embeds(self):
        ...
        alerted_messages = []  # Used to skip already once alerted messages
        ...
        while True:
            ...
            for channel in self.get_all_channels():
                ...
                async for msg in channel.history():
                    if not msg.embeds or msg.id in alerted_messages:
                        continue

                    e = msg.embeds[0]

                    if not is_embed_up_to_date(e):
                        ...
                        alerted_messages.append(msg.id)
